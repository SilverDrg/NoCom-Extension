      ...
      <Container component='main' maxWidth='xs' sx={{ p: 0 }}>
        ...
        >
          ...
          <Typography
            variant='body2'
            align='left'
            sx={{ p: 2, borderTop: 2, borderColor: theme.palette.primary.main }}
          >
            NoCom is an extension enabling you to post comments on any website
            you visit, without having to worry about censorship or manipulation.
          </Typography>
          <Typography variant='h6' align='left' sx={{ m: 1 }}>
          ...
          <Typography
            ...
            sx={{ p: 2, borderTop: 2, borderColor: theme.palette.primary.main }}
          >
            NoCom is currently being developed by one person as a university
            project.
          </Typography>
          <Card elevation={6} sx={{ m: 2 }}>
            ...
            <CardMedia
              image={Placeholder}
              title='user image'
              sx={{ height: 160, width: 140, m: "auto" }}
            />
            <CardContent>
              <Typography
                variant='body1'
